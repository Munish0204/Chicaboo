...
const menuItems = [
  ...
  { path: "ethnic", label: "Ethnic Wear" },
  { path: "outwear", label: "OutWear" },
  { path: "Western", label: "Western Wear" },
  { path: "top&bottom", label: "Top&Bottom Wear" },
];

const WomenLayout = () => {
  return (
    <div className="max-w-7xl mx-auto px-4 py-6">
      <h1 className="text-3xl font-bold text-center mb-8">Wowens's Collection</h1>
